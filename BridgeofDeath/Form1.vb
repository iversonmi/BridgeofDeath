Public Class Form1
    ...
    Private Sub btnApproach_Click(sender As Object, e As EventArgs) Handles btnApproach.Click
        ...
        ElseIf intRandomQuestionNumber = 2 And strRandomQAnswer = "24 miles per hour." Then
            Me.lblFate.Text = "You may cross."
        ElseIf intRandomQuestionNumber = 2 And strRandomQAnswer <> "24 miles per hour." Then
            Me.lblFate.Text = "You die!!"
        ElseIf intRandomQuestionNumber = 3 And (strRandomQAnswer = "Ashur" Or strRandomQAnswer = "Calah" Or strRandomQAnswer = "Dur Sharrukin" Or strRandomQAnswer = "Neneveh") Then
            Me.lblFate.Text = "You may cross."
        ElseIf intRandomQuestionNumber = 3 And (strRandomQAnswer <> "Ashur" Or strRandomQAnswer <> "Calah" Or strRandomQAnswer <> "Dur Sharrukin" Or strRandomQAnswer <> "Neneveh") Then
            Me.lblFate.Text = "You die!!"
        ElseIf intRandomQuestionNumber = 4 And strRandomQAnswer = "27 feet" Then
            Me.lblFate.Text = "You may cross."
        ElseIf intRandomQuestionNumber = 4 And strRandomQAnswer <> "27 feet" Then
            Me.lblFate.Text = "You die!!"
        End If
